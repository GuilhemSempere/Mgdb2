...
@TypeAlias("GS")
public class GenotypingSampleArchive {
     ...
     */
    public GenotypingSampleArchive(int sampleId, int projectId, String run, String individual, String sampleName) {
        this.id = sampleId;
     ...
     * @param individual the individual
     */
    public GenotypingSampleArchive(int sampleId, int projectId, String run, String individual) {
...
//	}
    ...
    public GenotypingSampleArchive() {
    }
